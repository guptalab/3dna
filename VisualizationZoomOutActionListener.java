 ...
 */
public class VisualizationZoomOutActionListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if(MainFrame.isImported){
            ...
            VisualizePlaneActionListener.canvasZ=VisualizePlaneActionListener.canvasZ+VisualizePlaneActionListener.visualizePlaneCanvasStep;
