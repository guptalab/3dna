 ...
 */
public class VisualizationRightButtonActionListener implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        if(MainFrame.isImported){
            ...
            VisualizePlaneActionListener.canvasX=VisualizePlaneActionListener.canvasX-VisualizePlaneActionListener.visualizePlaneCanvasStep;
