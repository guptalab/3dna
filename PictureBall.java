...
public class PictureBall {
    ...
    public PictureBall() {
        ...
        TextureLoader loader = new TextureLoader("Arizona.jpg",
        ...
        TransparencyAttributes t_attr = new TransparencyAttributes(TransparencyAttributes.BLENDED,0f,TransparencyAttributes.BLEND_SRC_ALPHA,TransparencyAttributes.BLEND_ONE);
